...
## [Unreleased]
### Changed
- API: ignore country parameter on station add. it is autogenerated from countrycode.
- API: allow only countrycodes with the exact length of 2 on insert.
- API: ignore case on subtable selects (/format/codec, /format/country, /format/countrycode)
