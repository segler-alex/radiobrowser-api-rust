...
cd radiobrowser
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.6.7/radiobrowser-dist.tar.gz
...
```bash
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.6.7/radiobrowser-api-rust_0.6.7_amd64.deb
sudo apt install default-mysql-server
