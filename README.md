...
ansible-playbook -e "email=test@example.com" -e "version=0.6.13" -e "ansible_python_interpreter=auto" -i "test.example.com,test2.example.com" ansible/playbook.yml
```
