...
cd radiobrowser
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.7.18/radiobrowser-dist.tar.gz
...
```bash
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.7.18/radiobrowser-api-rust_0.7.18_amd64.deb
sudo apt install default-mysql-server
