...
cd radiobrowser
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.7.17/radiobrowser-dist.tar.gz
...
```bash
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.7.17/radiobrowser-api-rust_0.7.17_amd64.deb
sudo apt install default-mysql-server
