...
cd radiobrowser
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.7.22/radiobrowser-dist.tar.gz
...
```bash
wget https://github.com/segler-alex/radiobrowser-api-rust/releases/download/0.7.22/radiobrowser-api-rust_0.7.22_amd64.deb
sudo apt install default-mysql-server
...
docker pull segleralex/radiobrowser-api-rust:0.7.22
docker run \
    ...
    -e HOST=0.0.0.0 \
    -p 8080:8080 \
    segleralex/radiobrowser-api-rust:0.7.22 radiobrowser-api-rust -vvv
# show logs
...
ansible-playbook -e "email=test@example.com" -e "version=0.7.22" -e "ansible_python_interpreter=auto" -i "test.example.com,test2.example.com" ansible/playbook.yml
```
